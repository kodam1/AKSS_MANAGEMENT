<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="components-breadcrumbs.aspx.cs" Inherits="AKSS_Management.NiceAdminComponent.components_breadcrumbs" %>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <nav>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="/Default.aspx"><i class="bi bi-house-door"></i></a></li>
                  <li class="breadcrumb-item"><a href="#">Library</a></li>
                  <li class="breadcrumb-item active">Default</li>
                </ol>
              </nav>
