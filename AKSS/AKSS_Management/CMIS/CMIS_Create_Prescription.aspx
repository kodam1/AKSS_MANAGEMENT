<%@ Page Title="Prescription" Async="true" Language="C#" MasterPageFile="~/CMIS/CMIS.Master" AutoEventWireup="true" 
    CodeBehind="CMIS_Create_Prescription.aspx.cs" 
    Inherits="AKSS_Management.CMIS.CMIS_Create_Prescription" %>
      ...
      <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="row g-3 ">
                  ...
                  <div class="form-floating">
                    <asp:TextBox id="txtPrescriptionId" runat="server" class="form-control"   ></asp:TextBox><%-- AutoPostBack="true" OnTextChanged="txtClientId_TextChanged"--%>
                    <label for="txtPrescriptionId">Prescription Id</label>
                  </div>
                </div>
             ...
             <div class="col-6 col-md-6 mb-3">
               <div class="form-floating">
                  <asp:TextBox id="txtSelectMedicines" runat="server" class="form-control" Style="border-left: 8px solid #0000ff80;" disabled="disabled" Placeholder=" Select Patient"  ></asp:TextBox>   <%-- AutoPostBack="true" OnTextChanged="txtClientName_TextChanged"--%>                 
                 <label for="txtSelectMedicines"  Style="border-left: 8px solid #0000ff80;"> Medicines<span style="font-weight:600;color:red"> *</span></label>
               </div>
             </div>  
             <div class="col-6 col-md-6 mb-3">
               <div class="text-center" style="margin-top: 5px !important;">
                  <a  ID="BtnSelectMedicines" runat="server" class="btn btn-primary btn-lg"> <i class="bi bi-card-checklist me-1"></i> Select</a> 
               </div>
             </div> 
             </div>
       ...
       <div class="text-center">
         ...
         <button type="reset" class="btn btn-secondary">Reset</button>--%>
           ...
           <asp:Button ID="BtnSave" runat="server" Text="Create Prescription" class="btn btn-primary"/> <%--OnClick="BtnSave_Click" --%>
