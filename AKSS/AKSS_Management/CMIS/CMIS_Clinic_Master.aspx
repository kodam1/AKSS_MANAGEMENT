...
<%--                    <div class="form-floating mb-3">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6 mb-3">
                     <div class="form-floating">
                       <asp:TextBox id="txtDoctorSpecialization" runat="server" class="form-control" TextMode="MultiLine" Height="100px" Width="100%" ></asp:TextBox>                                        
              ...
              <div class="row g-3">
               ...
               <div class="row g-3">
                <div class="col-md-6 mb-3">                
                    <div class="form-floating">
                      <asp:TextBox id="txtOldCasePrice" runat="server"  class="form-control"   TextMode="MultiLine" Height="100px" Width="100%" ></asp:TextBox>                                        
              ...
              <div class="row g-3">
                <div class="col-md-12 mb-3">                
                    <div class="form-floating">
                      ...
                      <label for="txtSpecialNotes">SpecialNotes<span style="font-weight:600;color:red"> *</span></label>
                    </div>                 
                </div>
                <div class="col-md-6 mb-3" style="display:none;">                
                   <div class="form-floating">
                     <asp:TextBox id="TextBox2" runat="server"  class="form-control"   TextMode="MultiLine" Height="100px" Width="100%" ></asp:TextBox>                                        
                     h<label for="TextBox2">Working Hours<span style="font-weight:600;color:red"> *</span></label>
                   </div>                 
               </div>
