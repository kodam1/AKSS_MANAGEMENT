                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                     <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-puzzle"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>145</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card" style="cursor: pointer;">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-person-check"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>3,264</h6>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card" style="cursor: pointer;">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" >
                     <a href="/DefaultCMIS.aspx" target="_blank">  <i class="bi bi-person-plus"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>1244</h6>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background-color: #f2ff0045;">
                      <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-newspaper"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>637</h6>
                      <%--<span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background: #f5dce7;">
                      <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-file-plus"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>1376</h6>
                      <%--<span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background: #e6d4ee;">
                      <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-journal-text"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>2338</h6>
                      <%--<span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease</span>--%>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background: #cfedf0;">
                      <a href="/DefaultCMIS.aspx" target="_blank"> <i class="bi bi-download"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>98</h6>
                      <%--<span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">increase</span>--%>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background: #e0eef0;">
                     <a href="/DefaultCMIS.aspx" target="_blank">  <i class="bi bi-card-checklist"></i></a>
                    </div>
                    <div class="ps-3">
                      <h6>101</h6>
                      <%--<span class="text-danger small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">decrease</span>--%>
